    ...
    <div id="page" class="s-pagewrap">
            ...
            <div class="row s-header__inner">
                ...
                <nav class="s-header__nav">
                    ...
                    <ul class="s-header__social" style="align-items: center;">
                        <li>
                        <a href="{{route('signin')}}" style="color: white; margin-right: 10px; " onmouseover="this.style.color='rgb(230, 157, 1)'" onmouseout="this.style.color='white'" >
                            SIGN IN
                        </a>
                        </li>
                        <li>
        ...
        <section id="content" class="s-content">
                ...
                <div class="row s-intro__content">
                    ...
                    <div class="column lg-12 s-intro__content-inner">
                        ...
                        <h1 class="s-intro__content-title">
                            Unifying PSU for a <br> Stronger Tomorrow
                        </h1>

                        <div class="s-intro__content-buttons">
                            <a href="#about" class="btn btn--stroke s-intro__content-btn smoothscroll">Learn More</a>
                            <a href="https://www.youtube.com/embed/2cXjamzRnHM?si=tYDulGCBO25XBOb9" class="s-intro__content-video-btn">
            ...
            <section id="about" class="s-about target-section">
                ...
                <div class="row section-header" data-num="01">
                    ...
                    <div class="column lg-6 stack-on-1100 section-header__primary">
                        ...
                        PSUnify makes managing Pangasinan State University (PSU) student organizations easy, while also helping students connect seamlessly, fostering a vibrant community experience.
                        </h2>
                    </div>
                    <div class="column lg-6 stack-on-1100 section-header__secondary">
                        <p class="desc">
                        We're all about making things better for you, plain and simple. Our team is dedicated to finding smart solutions that help PSU students thrive. With PSUnify, we're making it easier than ever to stay organized and connected.
                        </p>
                    </div>
                ...
                <div class="row process-list list-block show-ctr block-lg-one-half block-tab-whole">
                    ...
                    <div class="column list-block__item">
                        ...
                        <div class="list-block__text">
                            <p>
                            We're all about giving you the tools to take charge. PSUnify puts the power in your hands, so you can plan events, engage members, and run your group like a pro.
                            </p>
                        </div>
                    ...
                    <div class="column list-block__item">
                        ...
                        <div class="list-block__text">
                            <p>
                            At PSUnify, we're all about bringing students together. Our platform makes it super easy to chat, share ideas, and work together, no matter where you are on campus.
                            </p>
                        </div>
                    </div> <!-- end list-block__item -->
                    ...
                    <div class="column list-block__item">
                        ...
                        <div class="list-block__text">
                            <p>
                            We're always looking for new ways to make things better. PSUnify is packed with cool features and simple designs to make your life easier and your student experience more awesome. 
                            </p>
                        </div>
                    </div> <!-- end list-block__item -->
                    ...
                    <div class="column list-block__item">
                        ...
                        <div class="list-block__text">
                            <p>
                            Our goal is to get you pumped about what you're doing. PSUnify is here to help you dream big, get creative, and make a real difference on campus and beyond.
                            </p>
                        </div>
                    </div> <!-- end list-block__item -->
            ...
            <section id="services" class="s-services target-section">
                ...
                <div class="row section-header" data-num="02">
                    ...
                    <div class="column lg-6 stack-on-1100 section-header__primary">
                        <h2 class="title text-display-1">
                        At PSUnify, our services are crafted to propel your organization's growth and visibility to new heights.
                        </h2>
                    </div>
                    <div class="column lg-6 stack-on-1100 section-header__secondary">
                        <p class="desc">
                        We're here to simplify organization management, offering a comprehensive suite of tools and support to streamline operations and maximize impact. Our platform is designed to fuel student-led initiatives, enabling organizers to cultivate thriving communities and leave a lasting legacy at PSU.
                        </p>
                    </div>
                </div> <!-- end section-header -->
                ...
                <div class="row services-list list-block block-lg-one-half block-tab-whole">
                    ...
                    <div class="column list-block__item">
                        <div class="list-block__title">
                            ...
                            <h3 class="h5">Organization Creation</h3>
                        </div>
                        <div class="list-block__text">
                            <p>
                            PSUnify puts the power of organization creation in the hands of students, providing intuitive tools to establish and customize groups tailored to their passions and goals. With PSUnify, bringing your vision to life has never been easier.
                            </p>
                        </div>
                    </div> <!-- end list-block__item -->
                    ...
                    <div class="column list-block__item">
                        <div class="list-block__title">
                            ...
                            <h3 class="h5">Student Engagement</h3>
                        </div>
                        <div class="list-block__text">
                            <p>
                            We believe in the power of connection. PSUnify facilitates seamless interaction between students and organizations, empowering members to discover, join, and actively participate in communities that resonate with their interests and aspirations.
                            </p>
                        </div>
                    </div> <!-- end list-block__item -->
                    ...
                    <div class="column list-block__item">
                        <div class="list-block__title">
                            ...
                            <h3 class="h5">Event Management</h3>
                        </div>
                        <div class="list-block__text">
                            <p>
                            From club meetings to campus-wide gatherings, PSUnify simplifies event planning and promotion, ensuring organizers can effortlessly coordinate and communicate upcoming activities to members. With PSUnify, organizing events that captivate and inspire has never been more accessible.
                            </p>
                        </div>
                    </div> <!-- end list-block__item -->
                    ...
                    <div class="column list-block__item">
                        <div class="list-block__title">
                            ...
                            <h3 class="h5">Integrated Chat</h3>
                        </div>
                        <div class="list-block__text">
                            <p>
                            Communication is key to collaboration. PSUnify's integrated chat feature fosters real-time interaction among members, facilitating discussion, brainstorming, and decision-making within organizations. With PSUnify, staying connected and engaged has never been more effortless.
                            </p>
                        </div>
                    </div> <!-- end list-block__item -->
            ...
            <section id="folio" class="s-folio target-section">
                ...
                <div class="row section-header light-on-dark" data-num="03">
                    ...
                    <div class="column lg-6 stack-on-1100 section-header__secondary">
                        <p class="desc">
                        We're committed to providing intuitive tools and features that make navigating PSUnify a breeze, empowering users to maximize their experience.
                        </p>
                    </div>
                </div> <!-- end section-header -->
                ...
                <div id="modal-01" hidden>
                    <div class="modal-popup">
                        ...
                        <div class="modal-popup__desc">
                            ...
                            <p>Easily create accounts for students and organizers, simplifying access to PSUnify's features.</p>
                        </div>
                ...
                <div id="modal-02" hidden>
                    <div class="modal-popup">
                        ...
                        <div class="modal-popup__desc">
                            <h5>Join & Engage</h5>
                            <p>Explore and participate in student organizations seamlessly, connecting with like-minded peers.</p>
                        </div>
                ...
                <div id="modal-03" hidden>
                    <div class="modal-popup">
                        ...
                        <div class="modal-popup__desc">
                            ...
                            <p>Stay updated with organization posts and interact with content through likes and comments.</p>
                        </div>
                ...
                <div id="modal-04" hidden>
                    <div class="modal-popup">
                        ...
                        <div class="modal-popup__desc">
                            ...
                            <p>Communicate instantly with members through PSUnify's chat feature, fostering community interaction.</p>
                        </div>
                ...
                <div id="modal-05" hidden>
                    <div class="modal-popup">
                        ...
                        <div class="modal-popup__desc">
                            ...
                            <p>Personalize your profile to showcase your interests and accomplishments, enhancing your PSUnify experience.</p>
                        </div>
                ...
                <div id="modal-06" hidden>
                    <div class="modal-popup">
                        ...
                        <div class="modal-popup__desc">
                            ...
                            <p>Ensure a safe and inclusive community by reporting inappropriate behavior for prompt action.</p>
                        </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="s-testimonials__slide swiper-slide">
                                    <div class="s-testimonials__author">
                                        <img src="images/avatars/user-02.png" alt="Author image" class="s-testimonials__avatar">
                                    ...
                                    <p>
                                    Sobrang cool ng PSUnify! Dito, madali kaming nakakapag-plano at nakakapag-usap ng mga kasama sa org. Solid, salamat sa PSUnify sa support!
                                    </p>
                                ...
                                <div class="s-testimonials__slide swiper-slide">
                                    ...
                                    <p>
                                    Ang galing ng PSUnify! Nakakatuwa kasi mas madali na naming napaplano ang mga activities namin sa org. Solid ng features, sulit na sulit!
                                    </p>
                                </div> <!-- end s-testimonials__slide -->
                
                                <div class="s-testimonials__slide swiper-slide">
                                    <div class="s-testimonials__author">
                                        <img src="images/avatars/user-01.png" alt="Author image" class="s-testimonials__avatar">
                                        <cite class="s-testimonials__cite">
                                    ...
                                    <p>
                                    Grabe, sobrang helpful ng PSUnify! Hindi na kami nalilito sa pag-organize ng mga events sa org namin. Ang saya lang!
                                    </p>
                                </div> <!-- end s-testimonials__slide -->
                                ...
                                <div class="s-testimonials__slide swiper-slide">
                                    ...
                                    <p>
                                    Astig ng PSUnify! Sobrang dali ng paggamit, pati mga kasama sa org, mas nagiging active dahil dito. Salamat, PSUnify!
                                    </p>
                                </div> <!-- end s-testimonials__slide -->
        ...
        <footer id="footer" class="s-footer target-section">
            ...
            <div class="row section-header" data-num="04">
                ...
                <div class="column lg-6 stack-on-1100 section-header__primary">
                    <h2 class="title text-display-1">
                    Got suggestions, feedback, or ideas to improve PSUnify? Reach out to us at <a href="mailto:psunify@gmail.com" title="psunify@gmail.com">psunify@gmail.com</a> and let's collaborate and make PSUnify even better together!
                    </h2>
                </div>    
                <div class="column lg-6 stack-on-1100 section-header__secondary">
            ...
            <div class="row s-footer__bottom">
                ...
                <div class="column lg-6 tab-12 s-footer__bottom-left">
                    <ul class="s-footer__social">
                        <li>
                        <span>Allen James E. Alvaro</span><br>
                        </li>
                        <li>
                        <span>| BSIT 3A | A.Y. 2023-2024</span><br>
                        </li>
                    </ul>
                </div>
            ...
            <div class="ss-go-top">
                <a class="smoothscroll" title="Back to Top" href="#top">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(7, 48, 75, 1);transform: ;msFilter:;"><path d="M6 4h12v2H6zm5 10v6h2v-6h5l-6-6-6 6z"></path></svg>
                </a>
            </div> <!-- end ss-go-top -->
