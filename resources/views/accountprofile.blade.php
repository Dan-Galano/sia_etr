...
<body>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="#"><i class="fas fa-user"></i> &nbsp;&nbsp; Account
                            Profile</a>
    ...
    <div class="container" style="margin-top: 120px;">
        @if (Auth::check() && Auth::user()->type === 'member')
            <a href="{{ route('member-home-all') }}" class="btn btn-warning"><i class="fas fa-arrow-left"></i>&nbsp;
                Back</a>
        @else
            <a href="{{ route('organizer-home-all') }}" class="btn btn-warning"><i class="fas fa-arrow-left"></i>&nbsp;
                Back</a>
        @endif
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('profile.update', ['id' => $user->id]) }}"
                            ...
                            <div class="form-group row">
                                <label for="profile_photo" class="col-md-4 col-form-label text-md-right"></label>
                                <div class="col-md-6">
                                ...
                                @if (Auth::check() && Auth::user()->type === 'member')
                                    ...
                                    <div class="col-md-6">
                                        <input id="studentid" type="text"
                                            ...
                                            name="studentid" value="{{ old('studentid', $user->studentid) }}"
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit"
                                        class="btn btn-primary col-md-12">{{ __('Update Profile') }}</button>
                                </div>
                            </div>
                        </form>
                        <br>
                        ...
                        <form method="POST" action="{{ route('profile.updatePassword') }}">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit"
                                        class="btn btn-primary col-md-12">{{ __('Update Password') }}</button>
                                </div>
                            </div>
                        </form>
