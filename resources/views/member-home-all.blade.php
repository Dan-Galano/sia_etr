...
<body>
    <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-white justify-items-center">
        ...
        <li class="nav-item">
        <a class="nav-link" href="{{route('member-home')}}">Joined Organizations</a> 
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="#" style="border-bottom: 2px solid #ffaa00a9;color: #ff7b00">All Organizations</a>
            </li>
        </ul>
