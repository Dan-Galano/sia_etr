...
<body>
    ...
    <div class="container mt-5">
        ...
        @endif
        <form action="{{ route('attendance.store', ['org_id' => $orgId, 'event_id' => $post->id]) }}" method="POST">
            @csrf
            <div class="form-group row justify-content-center mt-5">
                ...
                <div class="col-sm-8 mt-5 d-flex justify-content-center">
                    <button type="submit" class="btn btn-primary" style="font-weight: bold; font-size: 20px;">Check
                        In</button>
                </div>
            </div>
        </form>
