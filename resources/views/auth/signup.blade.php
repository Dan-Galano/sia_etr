...
<div class="signup-container">
    ...
    <form id="student-form" method="POST" action="{{ route('signupStudent') }}" enctype="multipart/form-data" style="display: block;">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" id="stud_email" name="stud_email" value="{{ old('stud_email') }}">
            @error('stud_email')
        ...
        <div class="form-group text-center">
        <button type="button" id="signup-member-button" class="btn btn-primary btn-block">Sign Up as Student</button>
        </div>
    </form>

    <!-- Form for organization registration -->
    <form id="organization-form" method="POST" action="{{ route('signupOrganization') }}" enctype="multipart/form-data" style="display: none;">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" id="org_email" name="org_email" value="{{ old('org_email') }}">
            @error('org_email')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <div class="custom-file">
                <input type="file" class="custom-file-input" id="org_logo" name="org_logo" accept="image/*"  onchange="previewOrgLogo(event)">
        ...
        <div class="form-group">
        <img id="org-logo-preview"  class="img ml-2 rounded-circle mx-auto"  style="display:none; max-width: 200px; margin-top: 10px;" alt="Logo Preview">
        </div>
        <div class="form-group">
            <label>Upload Required Documents (CBL, Principles, Rules, etc.)</label>
            <div class="custom-file">
                <input type="file" class="custom-file-input" id="documents" name="documents[]" accept=".pdf,.docx,.jpg,.png,.jpeg" multiple onchange="handleFileSelect(event)">
        ...
        <div class="form-group text-center">
        <button type="button" id="signup-organizer-button" class="btn btn-primary btn-block">Sign Up as Organization</button>
        </div>
    </form>
</div>
...
<script>
    ...
    var photo = document.getElementById('photo').files[0] ? document.getElementById('photo').files[0].name : 'No photo selected';
