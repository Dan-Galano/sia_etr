                ...
                @if ($isMember)
                    <li class="nav-item">
                        <a class="nav-link btn btn-warning" style="color: black; font-weight: bolder;"
                            href="{{ route('chat.view', ['org_id' => $orgid]) }}"><i class="fas fa-comments"></i>&nbsp;
                            Chat</a>
                    </li>
                @endif
    ...
    <div class="container mt-4">
        ...
        <div class="tab-content mt-3" id="myTabContent">
            ...
            <div class="tab-pane fade" id="reports" role="tabpanel" aria-labelledby="reports-tab">
                ...
                <!-- reports table dito -->
                <a href="{{ route('export.reports.pdf', $organization->id) }}" class="btn btn-danger mb-3">EXPORT TO
                    PDF</a>
                <a href="{{ route('export.reports.csv', $organization->id) }}" class="btn btn-success mb-3">EXPORT TO
                    CSV</a>
                                ...
                                <div class="post-box">
                                    ...
                                    <div
                                        ...
                                        <div class="post-icons">
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#addPhotoModal">Add
                                                Photos</a>
                                        </div>
                                ...
                                <div class="post-box">
                                    ...
                                    <div class="row mr-2 ml-2">
                                        <div class="form-group mt-2 col-md-6">
                                            ...
                                            <input type="datetime-local" name="event_start_time" class="form-control"
                                                required>
                                        </div>
                                        <div class="form-group mt-2 col-md-6">
                                            <label for="event_end_time">Event End Time</label>
                                            <input type="datetime-local" name="event_end_time" class="form-control"
                                                required>
                                        </div>
                                    </div>
                                ...
                                <div class="post-header d-flex justify-content-between align-items-center">
                                    ...
                                    @if ($user->type == 'organizer')
                                        <div>
                                            ...
                                            <a href="#" class="btn btn-warning edit-post" data-toggle="modal"
                                                data-target="#editEventWithPhotoModal"
                                                data-post-id="{{ $post->id }}">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{ route('post.delete', $post->id) }}"
                                ...
                                <tbody>
                                    @foreach ($members as $member)
                                        <tr>
                                            ...
                                            <td>
                                                <button
                                                    class="{{ strtolower($member->status) === 'approved' ? 'btn btn-outline-success' : (strtolower($member->status) === 'rejected' ? 'btn btn-outline-danger' : 'btn btn-outline-secondary') }}">{{ $member->status }}</button>
                                            </td>
                                            <td>
                                                <form
                                                    ...
                                                    @method('PUT')
                                                    <button type="submit"
                                                        class="btn btn-{{ $member->status === 'approved' ? 'danger' : 'success' }}">
                                                        <i
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="{{ route('reports.store') }}"
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" id="somethingelse"
                                                                                name="reasons[]"
