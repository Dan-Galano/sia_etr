        ...
        try {
            ...
            if ($request->hasFile('documents')) {
                foreach ($request->file('documents') as $document) {
                    ...
                    $documentFilename = time() . '_' . uniqid() . '_' . preg_replace('/[^a-zA-Z0-9-_\.]/', '', $document->getClientOriginalName());
                    // Store the document in the public/org-docs directory
                    $document->move(public_path('org-docs'), $documentFilename);
